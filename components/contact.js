export default function Contact({ contact, resume, email }) {
    return (
        <div className="flex flex-col md:flex-row justify-end md:ml-10 mt-8 md:mb-12 space-x-4  md:space-y-0 space-y-2">
            <a href={`mailto:${email ?? "albacirerasant@gmail.com"}`} className="max-w-xs bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
